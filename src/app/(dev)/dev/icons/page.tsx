...
import SortByColIcon from '@/presentation/components/icons/sort-by-col.icon';
...
import ZoomInIcon from '@/presentation/components/icons/zoom-in.icon';
import ZoomOutIcon from '@/presentation/components/icons/zoom-out.icon';
      ...
      <div className="flex gap-10 p-10 mt-3 flex-wrap">
         {icons.map((icon) => {
            return (
               <div
                  key={icon.key}
                  className="flex gap-3 items-center cursor-pointer relative w-1/4 xl:w-[250px]"
                  data-tooltip
                  onClick={() => {
