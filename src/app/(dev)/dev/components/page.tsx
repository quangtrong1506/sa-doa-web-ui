...
const POST_DEMO: Post = {
   ...
   images: process.env.NEXT_PUBLIC_IS_IMAGE_DEFAULT
      ? BuildConfig.IMAGES_DEFAULT
      : BuildConfig.IMAGES_18,
};
const DemoComponentPage = () => {
   useEffect(() => {
      console.log('POST_DEMO', process.env.NEXT_PUBLIC_IS_IMAGE_DEFAULT);
   }, []);
