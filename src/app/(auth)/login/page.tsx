  ...
  render() {
    return (
      <>
        ...
        <section className="bg-gray-50 dark:bg-gray-900" style={{position:'absolute', top:"0px", zIndex: "99"}}>
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0" style={{height:'100vh', width:'100vw'}}>
            <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
              <Image src={'/images/logo.png'} className="w-8 h-8 mr-2" alt="logo" />
